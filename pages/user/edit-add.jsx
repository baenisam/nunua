...
const EditAnnonce = (props) => {
  ...
  const {
    ...
    error,
    loading: loadingEdit,
  } = useAsync(() => CathegorieService.getOneAnnonce(id));
  if (!id || !editData || editData?.length === 0) {
    return <ErrorPage />;
  }
  ...
  React.useEffect(() => {
    if (editData && id) {
      setCategory(editData?.category?.parent)
      setSousCategory(editData?.category)
      setProvince(editData?.lieu?.city)
      setRegion(editData?.lieu)
    
      setSelectedDelivery(
        editData?.delivery?.map((item) => {
          return {
            id: item.id,
            min:item.min,
            max:item.max,
            ...
            emplace:item.emplacement.name,
            deliver:item.deliver
          };
        })
      );
      setImages(
        editData?.images?.map((item) => {
          return {
            uid: item.id,
            name: item.id,
            status: "done",
            url: process.env.NEXT_PUBLIC_ASSET_URL + "products/" + item.images,
          };
        })
      );
    }
  ...
  const { updateAnnonce, loading, saveDelivery } = useAnnonceSubmit(setShowModal);
  ...
  >
      <div className="">
        ...
        >
          <Card className="bg-white">
            <div className="mx-auto col-12 col-md-12 col-lg-12">
              <div className="row mt-1">
                ...
                <label className="col-lg-12 col-md-12 mt-1">Emplacement</label>
                <div className="col-md-6 col-lg-6">
                  <Autocomplete
                    popupIcon={<FiChevronRight size={20} color="light" />}
                    size="large"
              ...
              <div className="row mt-1">
                <div className="col-md-6 col-lg-6">
                  <TextField
                    id="filled-basic"
                    style={{ width: "100%" }}
                    label="Votre numéro de téléphone (Ex:243999999999)"
                    variant="filled"
                    inputProps={{ style: { fontSize: 16 } }}
                    InputLabelProps={{ style: { fontSize: 16 } }}
                    name="phone"
              ...
              <div className="row mt-1">
                <div className="col-lg-12 col-md-12 mt-2">
                  ...
                  <p>
                    ...
                    l'ordre des photos : il vous suffit de saisir vos photos et
                ...
                <div className="row">
                  ...
                  {listLivraison?.length > 0 && (
                    <>
                      ...
                      >
                        <span className="text-danger text-center">Annuler</span>
                      </button>
                    </>
                  )}
                </div>
          ...
          <Card className="bg-white pt-1 pb-1 mb-2">
            <div className="mx-auto col-12 col-md-5 col-lg-5">
              <button
                type="submit"
              ...
              >
                ...
                <span className="ml-4">Modifier cette annonce</span>
              </button>
              
            </div>
          </Card>
        </form>
        <MainModal open={showModal} closeModal={() => setShowModal(!showModal)}>
          ...
          >
            ...
            <div className="row mt-1">
              <Autocomplete
                ...
                getOptionLabel={(option) => option.name}
                renderOption={(props, option) => (
                  <Box component="button" style={{ width: "100%" }} {...props}>
                    {option.name}
                  </Box>
                )}
                renderInput={(params) => (
            ...
            <div className="row mt-1">
              ...
              <div className="col-6 p-1">
                <TextField
                  ...
                  error={validation.touched.minDay && validation.errors.minDay}
                />
              </div>
              ...
              <div className="col-6 p-1">
                <TextField
                  ...
                  error={validation.touched.maxday && validation.errors.maxday}
                />
              </div>
            </div>
