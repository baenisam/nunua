...
function About () {
    ...
    return (
        <div className="main">
            <MetaDocument title={"A propos de nous"}/>
            ...
            <div className="container">
                <div className="page-header page-header-big text-center" style={ { backgroundImage: `url(images/about-header-bg.jpg)` } } >
                    <h1 className="page-title text-white">A propos de nous<span className="text-white">Qui nous sommes</span></h1>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 mb-3 mb-lg-0">
                            ...
                            <p>{globalSettings?.vision}</p>
                        </div>

                        <div className="col-lg-6">
                            <h2 className="title">Notre mission</h2>
                            <p>{globalSettings?.mission}</p>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-5 mb-3 mb-lg-0">
                                ...
                                <p className="mb-2">{globalSettings?.about_us}</p>
{/* 
