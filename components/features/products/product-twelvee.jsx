                ...
                <div className="product-action-vertical">
                    {
                        isInWishlist( wishlist, product ) ?
                            <ALink href="/shop/wishlist" className="btn-product-icon btn-wishlist btn-expandable added-to-wishlist" title="Go to Wishlist"></ALink>
                            :
                            <a href="#" className="btn-product-icon btn-wishlist btn-expandable" title="Add to Wishlist" onClick={ onWishlistClick }></a>
